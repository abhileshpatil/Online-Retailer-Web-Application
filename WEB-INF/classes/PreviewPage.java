...
public class PreviewPage extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request,
		...
		System.out.println("Preview Page rdiscount"+request.getParameter("rdiscount"));
		System.out.println("Preview Page rwarranty"+request.getParameter("rwarranty"));
  ...
  public void doGet(HttpServletRequest request,
    ...
    String contentStr = "<hr><h1 style=\"background-color: #e9e9e9;padding-left: 30px;padding-top: 10px;\"> Preview Order</h1> <hr>";
    ...
    if(orderproducts != null && !orderproducts.isEmpty()) {
    	for(Entry<String, Product> m :orderproducts.entrySet()){
			...
			System.out.println("In preview page"+c.getCategory());
			System.out.println("In preview page"+m.getKey());
			System.out.println("In preview page"+c.getRdiscount());
			System.out.println("In preview page"+c.getRwarranty());
			System.out.println("In preview page"+c.getDiscount());
	  		 contentStr = contentStr +
	 			...
	 			"            <div class=\"prod_price_big\"> price : <span class=\"price\">$"+c.getPrice()+"</span></div>"+
				 			 "<form action=\"/SmartPortables/preview?act=remove\" method = \"post\">"+
					 			...
					 			"</form>"+
					 			 "<form action=\"/SmartPortables/preview?act=removewarranty\" method = \"post\">"+
						 			"  <input type=\"hidden\" name=\"name\" value= \""+c.getName()+"\">"+
    ...
    if(cartacc != null && !cartacc.isEmpty()) {
		...
		for(Entry<String, Accessory> ma :cartacc.entrySet()){
			...
			contentStr = contentStr +"<div class=\"prod_box\">"+
					...
					"        <div class=\"prod_details_tab\"> "
					 +"<form action=\"/SmartPortables/preview?act=removeacc\" method = \"post\">"+
    	...
    	contentStr = contentStr + 	
    			...
    			"          <div class=\"contact_form\">"+
    						"<form action=\"/SmartPortables/myaccount/salesman/orders\" method=\"post\">"+
    			...
    			"              <input type=\"text\" name=\"zip\" class=\"contact_input\" />"+
    			"            </div>"+
    			"            <div class=\"form_row\">"+
