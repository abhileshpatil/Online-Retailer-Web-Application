...
public class MongoDBDataStoreUtilities {
	...
	static MySQLDataStoreUtilities mySQLStore = new MySQLDataStoreUtilities();
	...
	public static void getConnection()
	{
		...
		DB db = mongo.getDB("OnlineRetailer");
	...
	public static HashMap<String, ArrayList<Review>> selectReview()
	{
		...
		while (cursor.hasNext())
		{
			...
			Review review = new Review(obj.getString("productModelName"), obj.getString("category"), obj.getDouble("price"),
	...
	public HashMap<String, ArrayList<Review>> reviewsByRetailerZip() {
		HashMap<String, ArrayList<Review>> reviewHashmap=new HashMap<String, ArrayList<Review>>();
		DBCursor cursor = myReviews.find();
		...
		{
			BasicDBObject obj = (BasicDBObject) cursor.next();
			if(! reviewHashmap.containsKey(obj.getString("retailerZip")))
			{
				ArrayList<Review> arr = new ArrayList<Review>();
				reviewHashmap.put(obj.getString("retailerZip"), arr);
			}
			ArrayList<Review> listReview = reviewHashmap.get(obj.getString("retailerZip"));
			Review review = new Review(obj.getString("productModelName"), obj.getString("category"), obj.getDouble("price"),
					obj.getString("retailerName"), obj.getInt("retailerZip"), obj.getString("retailerCity"), obj.getString("retailerState"),
					obj.getString("productOnSale"), obj.getString("manufacturerName"), obj.getString("manufacturerRebate"),
					obj.getString("userName"), obj.getInt("userAge"), obj.getString("userGender"),
	...
	public static HashMap<String, ArrayList<Review>> reviewsByAge()
	{
		...
		while (cursor.hasNext())
		{
			...
			ArrayList<Review> listReview = reviewHashmap.get(obj.getString("retailerCity"));
			Review review = new Review(obj.getString("productModelName"), obj.getString("category"), obj.getDouble("price"), obj.getString("retailerName"), obj.getInt("retailerZip"), obj.getString("retailerCity"), obj.getString("retailerState"),
					obj.getString("productOnSale"), obj.getString("manufacturerName"), obj.getString("manufacturerRebate"),
					obj.getString("userName"), obj.getInt("userAge"), obj.getString("userGender"),
					obj.getString("userOccupation"), obj.getInt("reviewRating"), obj.getDate("reviewDate"), obj.getString("reviewText"));
			listReview.add(review);
